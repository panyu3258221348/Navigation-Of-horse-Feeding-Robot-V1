...
configurable_parameters = [{'name': 'camera_name',                  'default': 'camera', 'description': 'camera unique name'},
                           ...
                           {'name': 'enable_pointcloud',
                               'default': 'true', 'description': 'enable pointcloud'},
                           {'name': 'unite_imu_method',             'default': '2',
                           ...
                           {'name': 'pointcloud.enable',            'default': 'true',
                               'description': 'pointcloud.enable attempts'},

                           {'name': 'decimation_filter.enable',            'default': 'true',
                            'description': 'decimation_filter.enable'},
                           {'name': 'decimation_filter.filter_magnitude',            'default': '6',
                            'description': 'Timeout(seconds) between consequtive reconnection attempts'},

                           {'name': 'temporal_filter.enable',            'default': 'true',
                               'description': 'temporal_filter.enable'},
                           {'name': 'spatial_filter.enable',            'default': 'true',
                            'description': 'filter'},
                           {'name': 'hole_filling_filter.enable',            'default': 'true',
                            'description': 'hole_filling_filter.enable'},
                           {'name': 'disparity_filter.enable',            'default': 'true',
                            'description': 'disparity_filter.enable'},
                           {'name': 'disparity_to_depth.enable',            'default': 'true',
                            'description': 'disparity_to_depth.enable'},
